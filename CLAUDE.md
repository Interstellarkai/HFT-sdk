...
The static library target is `HFT-sdk` (CMake alias `HFT::sdk`). All public headers live under `src/`; consumers include via `target_include_directories` pointing at `src/`.
