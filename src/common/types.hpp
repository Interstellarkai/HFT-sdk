#pragma once
// ============================================================================
// HFT-sdk — Core Types & Data Structures
// Fundamental type aliases, enumerations, and POD structures shared across
// all HFT-sdk modules: orders, trades, book levels, execution reports,
...
struct alignas(8) Symbol {
  // std::string is larger due to metadata and may be allocated on heap
  // (unless small-string optimization applies)
...
/* Matching engine trade record
 - Resting (passive) = already sitting in the order book
 - Incoming (aggressor) = the new order that just arrived
 */
