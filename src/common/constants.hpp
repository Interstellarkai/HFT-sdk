#pragma once
// ============================================================================
// HFT-sdk — Compile-Time Constants
...
static constexpr double DEFAULT_CANCEL_RATE =
    0.3;  // 30% of orders get cancelled
static constexpr double DEFAULT_INITIAL_MID_PRICE =
    10000;                                           // 100.00 in ticks (2 dp)
