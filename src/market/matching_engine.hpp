#pragma once
// ============================================================================
// HFT-sdk — Multi-Symbol Matching Engine
...
class MatchingEngine {
 public:
  ...
  // ── Statistics ─────────────────────────────────────────────────────
  [[nodiscard]] std::uint64_t total_orders_processed() const {
    return orders_processed_;
  }

  [[nodiscard]] std::uint64_t total_trades() const { return trades_generated_; }

  [[nodiscard]] std::uint64_t total_cancels() const {
    return cancels_processed_;
  }
