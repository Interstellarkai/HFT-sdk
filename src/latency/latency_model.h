...
public:
    ...
    void set_client_profile( HFT_sdk::TraderId trader_id, const LatencyProfile& profile );
    [[nodiscard]] const LatencyProfile& get_client_profile( HFT_sdk::TraderId trader_id ) const;
    ...
    [[nodiscard]] std::uint64_t sample_network_latency( HFT_sdk::TraderId trader_id );
